...
# make_classification makes two variables: X and y
...
# score_func is the quality measure function
...
# We evaluate it's performance on a specific feature set as using the recognition rate.
